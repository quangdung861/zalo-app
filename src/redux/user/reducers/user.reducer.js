...
const userReducer = createReducer(initialState, (builder) => {
  builder
    ...
    //=======GET_USER_LIST=======
    .addCase(REQUEST(USER_ACTION.GET_USER_LIST), (state, action) => {
      return {
        ...state,
        userList: {
          ...state.userList,
    ...
    .addCase(SUCCESS(USER_ACTION.GET_USER_LIST), (state, action) => {
      const { data } = action.payload;
      return {
        ...state,
        userList: {
    ...
    .addCase(FAIL(USER_ACTION.GET_USER_LIST), (state, action) => {
      const { error } = action.payload;
      return {
        ...state,
        userList: {
    ...
    //=======GET_USER_INFO_SELECTED=======
    .addCase(REQUEST(USER_ACTION.GET_USER_INFO_SELECTED), (state, action) => {
      return {
        ...state,
        userInfoSelected: {
          ...state.userInfoSelected,
          loading: true,
        },
      };
    })
    .addCase(SUCCESS(USER_ACTION.GET_USER_INFO_SELECTED), (state, action) => {
      const { data } = action.payload;
      return {
        ...state,
        userInfoSelected: {
    ...
    .addCase(FAIL(USER_ACTION.GET_USER_INFO_SELECTED), (state, action) => {
      const { error } = action.payload;
      return {
        ...state,
        userInfoSelected: {
